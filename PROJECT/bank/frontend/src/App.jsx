...
export default function App() {
  // Reveal rows one-by-one on scroll (1s stagger)
  useEffect(() => {
    // index each row for stagger delay
    const rows = document.querySelectorAll('.custom-table tbody .tx-row');
    rows.forEach((row, i) => row.style.setProperty('--i', i));

    const tbody = document.querySelector('.custom-table tbody');
    if (!tbody) return;

    // Observe the table area; start once when visible
    const io = new IntersectionObserver(
      (entries) => {
        const entry = entries[0];
        if (entry.isIntersecting) {
          tbody.classList.add('tx-start'); // triggers CSS keyframes
          io.disconnect(); // run once
        }
      },
      { threshold: 0.25 } // when ~25% of table is visible
    );
    ...
    <>
      <div className="homepage">
        <header className="navbar">
          ...
          <div className="auth-buttons">
            <Link to="/EmployeeLogin" className="signup login">Log in</Link>
          </div>
        </header>
      ...
      <section className='Exchange'>
        <div className='table-div'>
          ...
          <table className='custom-table'>
            ...
            <tbody>
              <tr className="tx-row">
                <td>10:29</td>
                <td><img className='currency-img' src={america} alt="" /> USD</td>
                <td>134.1388</td>
                <td>131.5086</td>
              </tr>
              <tr className="tx-row">
                <td>09:43</td>
                <td><img className='currency-img' src={uk} alt="" /> GBP</td>
                <td>174.4955</td>
                <td>177.9854</td>
              </tr>
              <tr className="tx-row">
                <td>23:08</td>
                <td><img className='currency-img' src={europe} alt="" /> EUR</td>
                <td>149.8277</td>
                <td>152.8243</td>
              </tr>
              <tr className="tx-row">
                <td>11:15</td>
                <td><img className='currency-img' src={china} alt="" /> CNY</td>
                <td>19.2789</td>
                <td>20.3011</td>
              </tr>
              <tr className="tx-row">
                <td>08:30</td>
                <td><img className='currency-img' src={japan} alt="" /> JPY</td>
                <td>00.9215</td>
                <td>00.9432</td>
              </tr>
              <tr className="tx-row">
                <td>07:50</td>
                <td><img className='currency-img' src={united} alt="" /> AED</td>
                <td>36.5123</td>
                <td>37.1088</td>
              </tr>
              <tr className="tx-row">
                <td>06:45</td>
                <td><img className='currency-img' src={saudi} alt="" /> SAR</td>
                <td>35.9087</td>
                <td>36.4075</td>
              </tr>
              <tr className="tx-row">
                <td>06:00</td>
                <td><img className='currency-img' src={canada} alt="" /> CAD</td>
                <td>99.1278</td>
                <td>101.398</td>
              </tr>
            </tbody>
        ...
        <div className='exchange-phone'>
          <img className="phone-screen" src={phone} alt="Phone UI" />
      ...
      <img className='atm-mashin' src={atm} alt="ATM" />

      <section className='atm-card'>
        <div className='cards'>
          <div className='card xybery'>
            <img className='card-img' src={xybery} alt="Xybery Classic" />
            <div>
          ...
          <div className='card gold'>
            <img className='card-img' src={gold} alt="Xybery Plus" />
            <div>
      ...
      <section className='latest-news'>
        {[...Array(4)].map((_, i) => (
          <div key={i} className='news-card'>
            <img className='news-img' src={atm} alt="news" />
